      ...
      <div className="flex px-[10px] items-center gap-[15px]">
        ...
        <div>
          ...
          <button
            ...
            className="mt-1 text-[13px] text-gray-400 hover:text-[#3797EF] transition cursor-pointer bg-transparent border-none p-0"
          >
            Don't have a profile? Join In here! {userDetails ? new Date(userDetails.date).toDateString() : ""}
          </button>
          {
            userDetails
